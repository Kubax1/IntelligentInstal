...
function App() {
  ...
  return (
    ...
    <div className={classes.wrapper}>
      <SimpleGrid cols={{ base: 1, sm: 3 }} spacing={150}>
        <div>
        ...
        <div className={classes.form}>
          <form onSubmit={sendEmail}>
            ...
            />
            <Checkbox
              label="* Zapoznałem/a się z Regulaminem oraz Polityką Prywatności i akceptuję ich warunki."
    ...
    <div className={classes.ContactMargin}>&nbsp;</div>
    <Footer/>
    </MantineProvider>
  );
}
